    ...
    return(
        ...
        <div className="Cocktail_Main_Top_Content">
            ...
            <div className="Cocktail_login_profile_content">
                ...
                {name ===undefined ?  <button id="coctail_current_states" onClick={repage_Sign_in}>로그인</button>: <button id="coctail_current_states" onClick={Logout}>로그아웃</button>}
                </div>
            </div>
        ...
        <div className="Cocktail_Menu_bar">
           ...
           <div id="Cocktail_home_icon_contain" onClick={repage_Chose}><img id="Cocktail_home_icon" src="./Main_cocktail/main_img/home_icon.png" alt="home_icon"></img></div>
