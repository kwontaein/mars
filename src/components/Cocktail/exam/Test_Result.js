    ...
    return(
        <div className="Test_Result_Container">
            <div className="Result_content_container">
                ...
                <div id="result_top_text1">{mode ==="cocktail" ? "조주기능사" : mode==="bakery" ? "제과 · 제빵기능사" : null}</div>
                <img id="result_top_line"src="./Main_cocktail/Test_Result/top_line.png" alt="top_line"/>
                <img id="result_video_picture" src= {mode==="cocktail" ? "./Main_cocktail/Test_Result/result_video_picture.png" : mode==="bakery" ? "./Main_cocktail/Test_Result/result_video_picture2.png" :null} alt="result_video_picture"/>      
                {{score}>=60 ? 
