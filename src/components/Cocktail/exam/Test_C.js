...
let explain = ['비시(vichy) 에비앙(evian) 페리에(perrier) 모두 프랑스 원산지',
                 '청주는 쌀, 찹쌀을 발효시켜 만든 덧술을 여과해 만든 맑은 술이다.',
                 '러시아 혁명 (1917) 이후 타국에 러시안들이 전파',
                 '위스키의 재료는 맥아, 보리, 호밀, 옥수수 등, 감자는 보드카',
                 '너무 많은 커피를 사용하면 물이 천천히나와 빨리 되지않는다.',
                 '절대적인 법적효력은 없고, 등급 몇개에만 법적효력이 있다.',
                 'Pot Still 위스키는 증류법에 의한 분류이다.',
                 '홍주(진도군) 전라남도 무형문화재 제 26호 <국가지정 아님.',
                 '이탈리아 로스팅이 제일 강하다',
                 '증류주 = 혼합물.',
                 '은기물은 은기물 전용 세척액에 오래담가두면 안된다.',
                 '와인판매(Wine Steward) = 소믈리에',
                 '객단가 = 매출액 / 고객수',
                 'Chaser는 술을 마시고 입안을 산뜻하게 하기 위해 곁들이는 음료이다',
                 '중성세제, 더운물 - 찬물',
                 'Stinger cocktail (스팅커 칵테일) 은 Brandy가 베이스이다.',
                 'margarita는 Tequila, triple sec, lemon juice를 이용한다.',
                 '1, 2, 4는 모두 "내가 내겠어"라는 의미이다. 3 은 더치페이.',
                 '= 다음 중 아바레로 만드는 spirit을 고르시오, Agave 선인장은 테킬라의 주재료',
                 'Pink Lady 칵테일엔 Egg white, Grenadine, Sweet Cream, Dry Gin이 들어간다.'
