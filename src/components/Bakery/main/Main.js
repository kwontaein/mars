...
export default function Main(){
    ...
    function LoginProp(props){
        return(
            setIsChange = props.msg
        )
    }
    ...
    return(
            ...
            <div className="Cocktail_login_profile_container">
                    <div className="Cocktail_login_profile_content">
                        <div id="Cocktail_login_mode_about">
                            {isChange === (null) ? "Guest Mode" : "유저님"}
                        </div>
                            {isChange === (null) ? (
                                <Link to="/Sign_page"><div id="Cocktail_login_mode_about2">로그인</div></Link>) : (
                                <div id="Cocktail_login_mode_about2">환영합니다</div>)
                        }
                    </div>
        ...
        <div className="Bakery_Menu_bar">
           ...
           <div id="Bakery_home_icon_contain" ><Link to="/"><img id="Bakery_home_icon" src="./Main_cocktail/main_img/home_icon.png" alt="home_icon"></img></Link></div>
