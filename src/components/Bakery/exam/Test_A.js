...
let explain =  ['파운드 케이크를 팬닝할 때 밑면의 껍질 형성을 방지하기 위해 이중팬을 가장 많이 사용함.',
'반죽형 케이크: 버터를 쳐서 주입시켜 만드는 것으로서 파운드케이크, 마블파운드, 초콜릿케이크 등이 있다',
'쿠키의 퍼짐성과 굵은 설탕 입자는 상관관계 있다.',
'설탕이 많으면 녹아서 흘러내린다.',
'좋은 튀김기름의 조건은 먼저 발열점이 높아야 한다.',
'파이를 냉장고에 휴지시키는 이유는 유지와 반죽의 굳은 정도를 같게하고 끈적임을 방지한다.',
'반죽의 비중은 팬 용적과는 아무런 관계가 없다',
'이스트와 저장성 증가와는 거리가 멀다',
'반죽온도가 낮으면 부피가 작고, 작은 기포가 형성되며 기공이 조밀하고 오븐에 굽는 시간이 약간 길어진다.',
'비중 = 반죽 / 물 = 50/60 = 0.8 단. 컵의 무게는 제외한다',
'커스터드 푸딩은 오븐에서 중탕으로 160~170℃에서 굽는다.',
'시폰형 반죽법은 별립법처럼 계란을 분리하여 작업한다',
'단순 아이싱을 만드는 데 들어가는 재료는 분당, 물, 물엿 등이다.',
'퐁당: 입에 넣으면 곧 녹는 부드러운 당과 카스텔라의 장식용 등으로 쓰인다.',
'어린 반죽은 빵 제품의 모서리가 예리하게 된다',
'지나친 반죽(과발효)이 제품에 미치는 영향은 부피와 팬흐름이 크며 향이 강하고 껍질이 두껍다.',
'식빵의 가장 일반적인 포장 온도는 35~40℃',
'재빵용 밀가루의 손상 전분은 4.5~8%의 함량을 갖고 있다.',
'용해도: 포화용액에 있어서의 용질의 농도, 보통 100G 가운데 들어있는데 용질의 양 혹은 용매 100g 에 대한 용질 그램수',
'발효의 목적 : 반죽의 속성, 빵의 풍미 생성, 반죽의 팽창작용'
