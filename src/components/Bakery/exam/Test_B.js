...
let explain = ['컨벡션오븐: 오븐에 팬이 부착되어있어 열을 신속하게 순환시키는 것이다.',
 '정형한 식빵 반죽을 팬에 넣을 때 이음매의 위치는 아래로 한다.',
 '식빵 반죽의 분할은 15~20분 이내로 한다.',
 '건조하기 때문에 윗면이 터지기 쉽다.',
 '스트레이트법의 반죽 온도는 28℃',
 '건포도식빵, 옥수수식빵, 야채식빵을 만들 때 건포도, 옥수수, 야채는 최종 단계 후에 투입한다.',
 '반죽물 온도 = (희망반죽온도X3) - (실내온도+밀가루온도+마찰계수)',
 '설비 휴무와 노무비 절감은 상관이 없다',
 '자율배합이란 유지의 함량과 당류의 함량이 적은 것이다.',
 '패리노그래프 : 밀가루의 흡수율(단백질 흡수율) 측정 (글루텐의 질 측정), 믹싱시간 측정, 내구성 측정',
 '익스텐소 그래프는 반죽의 신장성을 측정하는 기기이다.',
 '프로테아제: 단백질을 분해하는 역할을 한다',
 '칼슘염의 주요 기능은 물 조절제 역할을 하는 것이다.',
 '우유단백질: 아미노산 균형이 풍부하고 영양가가 높은 단백질(리피아제: 효소)',
 '커스터드 크림에서 계란은 결합제 역할을 한다',
 '제빵용 이스트를 저장하는 온도는 냉장고 온도이다',
 '리피아제: 트리아실글리세롤을 디아실글리세롤과 지방산으로 가수분해하는 효소이다.',
 '강력분 : 단백질과 특히 글루텐의 성분 함유랑이 많은 질 좋은 밀가루',
 '글레이즈의 사용 온도는 40~45℃이다.',
 '제빵에서 설탕의 기능: 이스트의 영양분, 껍질색, 향을 향상, 노화지연'
